...
ifneq ($(filter amogus, $(TARGET_DEVICE)),)
...
SENSORS_CONFIG_MOUNT_POINT := $(TARGET_OUT_VENDOR)/etc/sensors/config
$(SENSORS_CONFIG_MOUNT_POINT):
	@echo "Creating $(SENSORS_CONFIG_MOUNT_POINT)"
